...
def run(settings):
    ...
    settings.center_jitter_factor = {'template': 3, 'search': 5.5}
    settings.scale_jitter_factor = {'template': 0.25, 'search': 0.5}
    ...
    dataset_train = sampler.DiMPSampler([lasot_train, got10k_train, trackingnet_train, coco_train], [1,1,1,1],
                                        samples_per_epoch=50000, max_gap=500, num_search_frames=3, num_template_frames=3,
    ...
    dataset_val = sampler.DiMPSampler([got10k_val], [1], samples_per_epoch=10000, max_gap=500,
                                      num_search_frames=3, num_template_frames=3,
