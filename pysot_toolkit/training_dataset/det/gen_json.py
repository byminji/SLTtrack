...
js = {}
data_path = ''
VID_base_path = join(data_path, 'ILSVRC2015')
...
json.dump(train, open(join(data_path, 'det/train.json'), 'w'), indent=4, sort_keys=True)
json.dump(val, open(join(data_path, 'det/val.json'), 'w'), indent=4, sort_keys=True)
